...
int optional_task(char* encoded, int encoded_length, char* original, int original_length) {
    int position = 0;
    int min_difference = encoded_length + 1;
    loop_i(52) {
        shift_string(encoded, encoded_length, 1);
        int difference = calc_difference(encoded, encoded_length, original, original_length);
...
int required_task(char* encoded, int encoded_length, char* original, int original_length) {
...
int main(int argc, char* argv[]) {
    ...
    if (optional) {
        exit_code = optional_task(encoded, encoded_length, original, original_length);
    } else {
        exit_code = required_task(encoded, encoded_length, original, original_length);
    }
